...
d3.select("#filter-btn").on("click", filteredDate);
...
function filteredDate() {
    ...
    var filteredDate = inputValue.filter(ufoSighting => ufoSighting.datetime === inputValue.trim());
    //var filteredDate = tableData.filter(ufoSighting => ufoSighting.datetime === inputValue.property("value"));
